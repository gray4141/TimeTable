import sqlite3, time, datetime, uuid, hashlib, sys, re
...
class TimeTable(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        tk.Tk.iconbitmap(self, default='eyeCon.ico')  # add an icon to the window
...
class Reports(tk.Frame):
    ...
    def totalHours(self, date1, date2):     # calculates total hours in date range requested
        ...
        if dateMatch1 is not None and dateMatch2 is not None:
            ...
            hour_text = 'Total hours for date range:\n\n' + str(total_period_regular) + ' regular\n' \
